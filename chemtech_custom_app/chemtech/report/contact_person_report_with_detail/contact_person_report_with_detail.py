...
def get_data(filters):
    if filters:
        data = frappe.db.sql(""" SELECT DISTINCT cu.sales_person as sales_person_name,cu.customer_name as customer_name,co.address as contact_address,
            ...
            co.mobile_no as mobile_no,co.phone as landline,co.email_id as email_id,co.area_of_interest_2 as area_of_interest_2,co.hplc as hplc,co.uplc as uplc,co.gchs as gchs,co.gcms as gcms,
