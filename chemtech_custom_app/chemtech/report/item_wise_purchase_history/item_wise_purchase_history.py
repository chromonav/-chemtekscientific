...
def get_data(filters):
    ...
    for record in purchase_order_records:
        ...
        row = {
            ...
            "brands": supplier_record.get("brands"),  # Include brands
...
def get_supplier_details():
    details = frappe.get_all(
        "Supplier",
        fields=["name", "supplier_name", "supplier_group", "custom_brand"]  # Include custom_brand field
    )
    ...
    for d in details:
        supplier_details.setdefault(
            ...
            frappe._dict({
                ...
                "brands": d.custom_brand or "",  # Map custom_brand field
            }),
        )
